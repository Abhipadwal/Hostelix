...
$aid = isset($_SESSION['id']) ? $_SESSION['id'] : 0;
 // Set a default value if 'id' is not in the session
...
if (isset($_POST['update'])) {
	...
	$udate = date('Y-m-d H:i:s'); // Use this format for MySQL datetime

	$query = "UPDATE users SET regNo=?, firstName=?, middleName=?, lastName=?, gender=?, contactNo=?, updationDate=? WHERE id=?";
